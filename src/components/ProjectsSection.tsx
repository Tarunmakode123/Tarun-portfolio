    ...
    >
      ...
      >
        ...
        <div className="flex flex-row items-start justify-between gap-4 sm:gap-6">
          <div className="flex flex-row items-start gap-4 sm:gap-6 md:gap-10 min-w-0">
            <div
            ...
            <div className="flex flex-col gap-2 sm:gap-3 pt-2 sm:pt-3 md:pt-4 min-w-0">
              <span
          ...
          <div className="shrink-0 pt-1 sm:pt-2 md:pt-3">
